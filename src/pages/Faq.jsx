...
const faqs = [
     {
          ...
          answer: 'Depending on your cabinet needs, we offer lead times anywhere from 6 -18 weeks.',
     },
     {
          question: 'Do you use your own installers?',
          answer: 'Kustomcabs LLC employs custom cabinet installers with the same craftsmanship of those who handcraft our custom cabinetry. We also team up with some of the best installation teams in the valley to assure fast service combined with quality installations.',
     },
     {
          question: 'Can we save our existing cabinets/countertops?',
          answer: 'Often times your cabinets can be refinished to bring a new and fresh look to your existing kitchen. We use furniture-grade spray equipment and a state-of-the-art cabinetry spray booth for laying down the best lacquer finishes available.',
     },
     {
               ...
               <div className='mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:py-20 lg:px-8'>
                    <div className='lg:grid lg:grid-cols-3 lg:gap-8'>
                         <div className='h-[max-content] lg:sticky top-[200px]'>
                              <h2 className='font-serif text-gold text-4xl'>
                                   How can we help?
                              </h2>
                              <p className='mt-4 text-lg text-gray-dark'>
                                   ...
                                   {contacts.map((contact) => (
                                        <Link
                                             to={contact.hrefphone}
                                             className='font-medium text-gray-dark hover:text-gold'
                                        >
                                             {' '}
                                             sales team.
                                        </Link>
                              ...
                              <dl className='space-y-12'>
                                   {faqs.map((faq) => (
                                        <div key={faq.question}>
                                             <dt className='text-lg font-medium leading-6 text-gray-dark'>
                                                  {faq.question}
                                             </dt>
